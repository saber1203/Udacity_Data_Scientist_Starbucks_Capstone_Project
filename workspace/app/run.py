...
def go():
    ...
    user_offer_recs=user_offer_info[['offer_id','prob_completed']].sort_values(by='prob_completed',ascending=False)

    classification_labels = user_offer_recs['prob_completed']
